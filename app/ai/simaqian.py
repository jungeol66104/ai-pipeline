...
from app.utils import modify_storage_file
# refactoring: clear


def simaqian(text_packet):
    subject = text_packet["subject"]
    iteration = text_packet["iteration"]
    ...
    events_packet = {"subject": subject, "iteration": iteration, "events": events}

    modify_storage_file('simaqian', {"input": input_data, "output": output_data}, 'temporary.json')
